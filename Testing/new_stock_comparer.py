...
def main():
    ...
    # print(increase_dict)
    if len(stock_info) == 1: #man only bought one stock 
...
print("...This section is for backtesting...")
class MyInput:
    def __init__(self, numstock, investment_period, historical_range, stock_info):
        pass
